...
const config = {
    TIO GUI: '📍TIO GUI📍',
    instagram: 'https://www.instagram.com/invites/contact/?i=15dv8az6lgx7j&utm_content=ifpheqe',
    nomer: 'wa.me/5521992132053',
    aktif: '24 JAM',
    youtube: 'https://youtube.com/channel/UCjTIxL6ossZA6KGj7AF2zjQ',
    whatsapp: 'https://chat.whatsapp.com/FmNof33RaxD8j8R5caaSMv',
    tanggal: `TANGGAL: ${moment().format('DD')} ${bulan} ${moment().format('YYYY')}`,
    waktu: time
}

const { TIO GUI, tanggal, waktu, instagram, whatsapp, youtube, nomer, aktif, ontime } = config
